...
public class Questions {
    ...
    private String mChoices [][] = {
            {"6","7","8","9"},
            {"Słońce","Alfa Centauri A","Proxima Centauri","Syriusz"},
            {"Łajka","Sputnik 1","Sputnik 2","Apollo 1"},
            {"SpaceX","NASA","ZSRR","ESA"},
            {"Wodstok 1","Wostok 1","Apollo 11","Gemini 1"},
            {"z fałszywej próżni","z ciemnej materii","z rozpadu protonów","z próżni doskonałej"},
            {"płaski","ma kształt elipsy","holograficzną iluzją","ma cztery wymiary"},
            {"Alfa Centauri B","Alfa Centauri A","Proxima Centauri","Syriusz"},
            {"Jan Heweliusz","Issac Newton","Blaise Pascal","Stephen Hawking"},
